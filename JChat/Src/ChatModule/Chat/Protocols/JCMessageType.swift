...
//    @objc optional func message(message: JCMessageType, text:String)
...
public protocol JCRedMessageDelegate : JCMessageDelegate {
    func message(isRecive:Bool, message: JCMessageType, text:String) //是否已领取
}
